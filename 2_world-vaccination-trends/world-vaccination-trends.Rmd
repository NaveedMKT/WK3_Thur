...
library(tidyverse)
library(here)
world_vaccination <- read_csv(here("data", "world_vaccination.csv")) %>% 
...
```{r}
world_vaccination %>%
ggplot(aes(x = yr, y = pct_vaccinated, color = vaccine)) +
  geom_point() +
  labs(title = "Difference between the two types of vaccine", x = "Year", y = "Percentage Vaccinated")
```
...
```{r}
polio_regions <- polio_data %>%
  ggplot(aes(x = yr, y = pct_vaccinated, color = who_region, shape = who_region)) +
  geom_point() +
  labs(title = "Analysis of Polio Vaccine", x = "Year", y = "Percentage Vaccinated")
```
...
world_vaccination %>%
  ...
  geom_point() +
  theme_classic() +
  labs(title = "Analysis of Vaccine", x = "Year", y = "Percentage Vaccinated", color = "WHO Region") +
